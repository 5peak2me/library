 ...
 * ━━━━━━感觉萌萌哒━━━━━━
 */
public class TabIndicator extends HorizontalScrollView implements ViewPager.OnPageChangeListener, OnClickListener {
...
//                lp.rightMargin = mTabPadding;
    ...
    private void notifyDataSetInvalidated() {
        ...
        final int count = adapter.getCount();
        for (int i = 0; i < count; i++) {
            CheckedTextView tv = getTabView(i);
            CharSequence title = adapter.getPageTitle(i);
            if (title == null)
                title = "NULL";
